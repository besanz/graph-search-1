  ...
  # Include problem definition from the problem-template.R file
  source("../problem/problem-template.R")
  
  # Initialize your problem using one of the data files
  file_path <- "../data/map1.txt"
  problem <- initialize.problem(file_path)
  
  # Run the search algorithms using the initialized problem
